...
- NSIS installer: `src-tauri/target/release/bundle/nsis/Velocity Download Manager_2.0.3_x64-setup.exe`
- MSI installer: `src-tauri/target/release/bundle/msi/Velocity Download Manager_2.0.3_x64_en-US.msi`
